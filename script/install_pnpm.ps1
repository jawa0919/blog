...
# $pkgInfo = Invoke-WebRequest "https://registry.npmmirror.com/@pnpm/exe" -UseBasicParsing
# $pkgInfo = Invoke-WebRequest "https://mirrors.cloud.tencent.com/npm/@pnpm/exe" -UseBasicParsing
$pkgInfo = Invoke-WebRequest "https://mirrors.huaweicloud.com/repository/npm/@pnpm/exe" -UseBasicParsing
...
Write-Host "Downloading pnpm from $archiveUrl`n" -ForegroundColor Green
