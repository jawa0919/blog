...
########################################################################################################################
$releasesFileName = "v2rayN-windows-64-SelfContained"
...
Write-Host "设置订阅分组-添加订阅 `https://proxy.v2gh.com/https://raw.githubusercontent.com/freefq/free/master/v2` " -ForegroundColor Green
